...
var ImageData = function(width, height, channels, data, trailer) {
  this.width    = width;
  this.height   = height;
...
ImageData.prototype.getPixel = function(x, y) {
  if (this.data[(y*this.width+x)*3] == 192 && this.data[(y*this.width+x)*3+1] == 192 && this.data[(y*this.width+x)*3+2] == 192) {
    return 1;
  } else {
    return 0;
  }
...
ImageData.prototype.getRawPixel = function(x, y) {
  return this.data[(y*this.width+x)*3]*65536 + this.data[(y*this.width+x)*3+1]*256 + this.data[(y*this.width+x)*3+2];
}
